...
def Series(): #60
	try:
		...
		link = common.OpenURL("http://netcine.info/tvshows/page/1/").replace('\n','').replace('\r','')
		l2 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.info/tvshows/page/2/").replace('\n','').replace('\r','')
		l3 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.info/tvshows/page/3/").replace('\n','').replace('\r','')
		l4 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.info/tvshows/page/4/").replace('\n','').replace('\r','')
		l5 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.info/tvshows/page/5/").replace('\n','').replace('\r','')
		l6 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.info/tvshows/page/6/").replace('\n','').replace('\r','')
...
#	try:
#		if CatGO=="0":
#			link = common.OpenURL("http://netcine.info/page/1/?mt").replace('\n','').replace('\r','')
#			l1 = re.compile("box_movies(.+)").findall(link)
#			l2 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/3/?mt").replace('\n','').replace('\r','')
#			l3 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/4/?mt").replace('\n','').replace('\r','')
#			l4 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/5/?mt").replace('\n','').replace('\r','')
#			l5 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/6/?mt").replace('\n','').replace('\r','')
#			l6 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/7/?mt").replace('\n','').replace('\r','')
#			l7 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/8/?mt").replace('\n','').replace('\r','')
#			l8 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/9/?mt").replace('\n','').replace('\r','')
#			l9 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/10/?mt").replace('\n','').replace('\r','')
#			l10 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/11/?mt").replace('\n','').replace('\r','')
#			l11 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/12/?mt").replace('\n','').replace('\r','')
#			l12 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/13/?mt").replace('\n','').replace('\r','')
#			l13 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/14/?mt").replace('\n','').replace('\r','')
#			l14 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/15/?mt").replace('\n','').replace('\r','')
#			l15 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/16/?mt").replace('\n','').replace('\r','')
#			l16 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/17/?mt").replace('\n','').replace('\r','')
#			l17 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/18/?mt").replace('\n','').replace('\r','')
#			l18 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/19/?mt").replace('\n','').replace('\r','')
#			l19 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/20/?mt").replace('\n','').replace('\r','')
#			l20 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/21/?mt").replace('\n','').replace('\r','')
#			l21 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/22/?mt").replace('\n','').replace('\r','')
#			l22 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/23/?mt").replace('\n','').replace('\r','')
#			l23 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/24/?mt").replace('\n','').replace('\r','')
#			l24 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/25/?mt").replace('\n','').replace('\r','')
#			l25 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/26/?mt").replace('\n','').replace('\r','')
#			l26 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/27/?mt").replace('\n','').replace('\r','')
#			l27 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/28/?mt").replace('\n','').replace('\r','')
#			l28 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/29/?mt").replace('\n','').replace('\r','')
#			l29 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/30/?mt").replace('\n','').replace('\r','')
#			l30 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/page/31/?mt").replace('\n','').replace('\r','')
...
##			l60 = re.compile("box_movies(.+)").findall(link)
	...
	#		link = common.OpenURL("https://netcine.info/ano-lancamento/2019/page/2/").replace('\n','').replace('\r','')
	#		l62 = re.compile("box_movies(.+)").findall(link)
	#		lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l60[0]+l61[0]+l62[0])            
	#	if CatGO=="2":        
	#		link = common.OpenURL("http://netcine.info/category/acao/?mt").replace('\n','').replace('\r','')
	#		l100 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/2/?mt").replace('\n','').replace('\r','')
	#		l101 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/3/?mt").replace('\n','').replace('\r','')
	#		l102 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/4/?mt").replace('\n','').replace('\r','')
	#		l103 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/5/?mt").replace('\n','').replace('\r','')
	#		l104 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/6/?mt").replace('\n','').replace('\r','')
	#		l105 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/7/?mt").replace('\n','').replace('\r','')
	#		l106 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/acao/page/8/?mt").replace('\n','').replace('\r','')
	#		l107 = re.compile("box_movies(.+)").findall(link)
#	#		link = common.OpenURL("http://netcine.info/category/acao/page/9/?mt").replace('\n','').replace('\r','')
#			l108 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/acao/page/10/?mt").replace('\n','').replace('\r','')
...
#			link = common.OpenURL("http://netcine.info/category/comedia/page/2/?mt").replace('\n','').replace('\r','')
#			l401 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/3/?mt").replace('\n','').replace('\r','')
#			l402 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/4/?mt").replace('\n','').replace('\r','')
#			l403 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/5/?mt").replace('\n','').replace('\r','')
#			l404 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/6/?mt").replace('\n','').replace('\r','')
#			l405 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/7/?mt").replace('\n','').replace('\r','')
#			l406 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/8/?mt").replace('\n','').replace('\r','')
#			l407 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/comedia/page/9/?mt").replace('\n','').replace('\r','')
...
#		if CatGO=="6":        
#			link = common.OpenURL("http://netcine.info/category/drama/?mt").replace('\n','').replace('\r','')
#			l500 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/2/?mt").replace('\n','').replace('\r','')
#			l501 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/3/?mt").replace('\n','').replace('\r','')
#			l502 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/4/?mt").replace('\n','').replace('\r','')
#			l503 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/5/?mt").replace('\n','').replace('\r','')
#			l504 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/6/?mt").replace('\n','').replace('\r','')
#			l505 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/7/?mt").replace('\n','').replace('\r','')
#			l506 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/8/?mt").replace('\n','').replace('\r','')
#			l507 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/9/?mt").replace('\n','').replace('\r','')
#			l508 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/10/?mt").replace('\n','').replace('\r','')
#			l509 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/11/?mt").replace('\n','').replace('\r','')
#			l510 = re.compile("box_movies(.+)").findall(link)
#			link = common.OpenURL("http://netcine.info/category/drama/page/12/?mt").replace('\n','').replace('\r','')
...
##			l900 = re.compile("box_movies(.+)").findall(link)
	...
	#	if CatGO=="11":        
	#		link = common.OpenURL("http://netcine.info/category/suspense/?mt").replace('\n','').replace('\r','')
	#		l1000 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/suspense/page/2/?mt").replace('\n','').replace('\r','')
	#		l1001 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/suspense/page/3/?mt").replace('\n','').replace('\r','')
	#		l1002 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/suspense/page/4/?mt").replace('\n','').replace('\r','')
	#		l1003 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/suspense/page/5/?mt").replace('\n','').replace('\r','')
	#		l1004 = re.compile("box_movies(.+)").findall(link)
	#		link = common.OpenURL("http://netcine.info/category/suspense/page/6/?mt").replace('\n','').replace('\r','')
...
#		pass
	try:
		...
		link2 = common.OpenURL("http://netcine.info/?s="+d).replace('\n','').replace('\r','')
