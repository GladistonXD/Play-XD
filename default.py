...
def Series(): #60
	try:
		...
		link = common.OpenURL("http://netcine.me/tvshows/page/3/").replace('\n','').replace('\r','')
		l4 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.me/tvshows/page/4/").replace('\n','').replace('\r','')
		l5 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.me/tvshows/page/5/").replace('\n','').replace('\r','')
		l6 = re.compile("box_movies(.+)").findall(link)
		link = common.OpenURL("http://netcine.me/tvshows/page/6/").replace('\n','').replace('\r','')
...
def MoviesNC(): #71
	...
	try:
		if CatGO=="0":
			...
			link = common.OpenURL("http://netcine.me/page/15/?mt").replace('\n','').replace('\r','')
			l15 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/16/?mt").replace('\n','').replace('\r','')
			l16 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/17/?mt").replace('\n','').replace('\r','')
			l17 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/18/?mt").replace('\n','').replace('\r','')
			l18 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/19/?mt").replace('\n','').replace('\r','')
			l19 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/20/?mt").replace('\n','').replace('\r','')
			l20 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/21/?mt").replace('\n','').replace('\r','')
			l21 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/22/?mt").replace('\n','').replace('\r','')
			l22 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/23/?mt").replace('\n','').replace('\r','')
			l23 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/24/?mt").replace('\n','').replace('\r','')
			l24 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/25/?mt").replace('\n','').replace('\r','')
			l25 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/26/?mt").replace('\n','').replace('\r','')
			l26 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/27/?mt").replace('\n','').replace('\r','')
			l27 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/28/?mt").replace('\n','').replace('\r','')
			l28 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/29/?mt").replace('\n','').replace('\r','')
			l29 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/page/30/?mt").replace('\n','').replace('\r','')
		...
		if CatGO=="1":        
			...
			l31 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/2/?mt").replace('\n','').replace('\r','')
			l32 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/3/?mt").replace('\n','').replace('\r','')
			l33 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/4/?mt").replace('\n','').replace('\r','')
			l34 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/5/?mt").replace('\n','').replace('\r','')
			l35 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/6/?mt").replace('\n','').replace('\r','')
			l36 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/7/?mt").replace('\n','').replace('\r','')
			l37 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/8/?mt").replace('\n','').replace('\r','')
			l38 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/acao/page/9/?mt").replace('\n','').replace('\r','')
			l39 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l31[0]+l32[0]+l33[0]+l34[0]+l35[0]+l36[0]+l37[0]+l38[0]+l39[0])
		if CatGO=="2":        
			link = common.OpenURL("https://netcine.info/category/animacao/").replace('\n','').replace('\r','')
			l40 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/animacao/page/2/?mt").replace('\n','').replace('\r','')
			l41 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/animacao/page/3/?mt").replace('\n','').replace('\r','')
			l42 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/animacao/page/4/?mt").replace('\n','').replace('\r','')
			l43 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l40[0]+l41[0]+l42[0]+l43[0])
		if CatGO=="3":        
			link = common.OpenURL("https://netcine.info/category/aventura/").replace('\n','').replace('\r','')
			l44 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/aventura/page/2/?mt").replace('\n','').replace('\r','')
			l45 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/aventura/page/3/?mt").replace('\n','').replace('\r','')
			l46 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/aventura/page/4/?mt").replace('\n','').replace('\r','')
			l47 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l44[0]+l45[0]+l46[0]+l47[0])
		if CatGO=="4":        
			link = common.OpenURL("https://netcine.info/category/comedia/").replace('\n','').replace('\r','')
			l48 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/2/?mt").replace('\n','').replace('\r','')
			l49 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/3/?mt").replace('\n','').replace('\r','')
			l50 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/4/?mt").replace('\n','').replace('\r','')
			l51 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/5/?mt").replace('\n','').replace('\r','')
			l52 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/6/?mt").replace('\n','').replace('\r','')
			l53 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/7/?mt").replace('\n','').replace('\r','')
			l54 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/8/?mt").replace('\n','').replace('\r','')
			l55 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/comedia/page/9/?mt").replace('\n','').replace('\r','')
			l56 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l48[0]+l49[0]+l50[0]+l51[0]+l52[0]+l53[0]+l54[0]+l55[0]+l56[0])            
		if CatGO=="5":        
			link = common.OpenURL("http://netcine.me/category/drama/?mt").replace('\n','').replace('\r','')
			l57 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/2/?mt").replace('\n','').replace('\r','')
			l58 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/3/?mt").replace('\n','').replace('\r','')
			l59 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/4/?mt").replace('\n','').replace('\r','')
			l60 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/5/?mt").replace('\n','').replace('\r','')
			l61 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/6/?mt").replace('\n','').replace('\r','')
			l62 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/7/?mt").replace('\n','').replace('\r','')
			l63 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/8/?mt").replace('\n','').replace('\r','')
			l64 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/9/?mt").replace('\n','').replace('\r','')
			l65 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/10/?mt").replace('\n','').replace('\r','')
			l66 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/11/?mt").replace('\n','').replace('\r','')
			l67 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/drama/page/12/?mt").replace('\n','').replace('\r','')
			l68 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l57[0]+l58[0]+l59[0]+l60[0]+l61[0]+l62[0]+l63[0]+l64[0]+l65[0]+l66[0]+l67[0]+l68[0])
		if CatGO=="6":        
			link = common.OpenURL("https://netcine.info/category/fantasia/").replace('\n','').replace('\r','')
			l69 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/fantasia/page/2/?mt").replace('\n','').replace('\r','')
			l70 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/fantasia/page/3/?mt").replace('\n','').replace('\r','')
			l71 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l69[0]+l70[0]+l71[0])
		if CatGO=="7":        
			link = common.OpenURL("https://netcine.info/category/ficcao-cientifica/").replace('\n','').replace('\r','')
			l72 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/ficcao-cientifica/page/2/?mt").replace('\n','').replace('\r','')
			l73 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/ficcao-cientifica/page/3/?mt").replace('\n','').replace('\r','')
			l74 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/ficcao-cientifica/page/4/?mt").replace('\n','').replace('\r','')
			l75 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l72[0]+l73[0]+l74[0]+l75[0])
		if CatGO=="8":        
			link = common.OpenURL("https://netcine.info/category/faroeste/").replace('\n','').replace('\r','')
			l76 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l76[0])
		if CatGO=="9":        
			link = common.OpenURL("https://netcine.info/category/romance/").replace('\n','').replace('\r','')
			l77 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/romance/page/2/?mt").replace('\n','').replace('\r','')
			l78 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/romance/page/3/?mt").replace('\n','').replace('\r','')
			l79 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l77[0]+l78[0]+l79[0])
		if CatGO=="10":        
			link = common.OpenURL("http://netcine.me/category/suspense/?mt").replace('\n','').replace('\r','')
			l80 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/suspense/page/2/?mt").replace('\n','').replace('\r','')
			l81 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/suspense/page/3/?mt").replace('\n','').replace('\r','')
			l82 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/suspense/page/4/?mt").replace('\n','').replace('\r','')
			l83 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/suspense/page/5/?mt").replace('\n','').replace('\r','')
			l84 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("http://netcine.me/category/suspense/page/6/?mt").replace('\n','').replace('\r','')
			l85 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l80[0]+l81[0]+l82[0]+l83[0]+l84[0]+l85[0])
		if CatGO=="11":        
			link = common.OpenURL("https://netcine.info/category/terror/").replace('\n','').replace('\r','')
			l86 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/terror/page/2/?mt").replace('\n','').replace('\r','')
			l87 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/terror/page/3/?mt").replace('\n','').replace('\r','')
			l88 = re.compile("box_movies(.+)").findall(link)
			link = common.OpenURL("https://netcine.info/category/terror/page/4/?mt").replace('\n','').replace('\r','')
			l89 = re.compile("box_movies(.+)").findall(link)
			lista = re.compile("img src\=\"([^\"]+).+?alt\=\"([^\"]+).+?f\=\"([^\"]+)").findall(l86[0]+l87[0]+l88[0]+l89[0])       
			lista = sorted(lista, key=lambda lista: lista[1])
		for img2,name2,url2 in lista:
			if name2!="Close":
				name2 = name2.replace("&#8211;","-").replace("&#038;","&").replace("&#8217;","\'")
...
def PlayMRC(): #95 Play filmes
	...
	try:
		...
		if player:
			...
			#url2 = m[0]
			#file = mp4[0][1]+".mp4"
			AddDir("[B][COLOR yellow]"+ name +" [/COLOR][/B]"  , file[0] + "|Referer="+ reference, 3, iconimage, iconimage, index=0, isFolder=False, IsPlayable=True, info=desc, background=url+";;;"+name+";;;RC")
		else:
...
def PlaySRC(): #133 Play series
	try:
		...
		if player:
			...
			mp4 = common.OpenURL(player ,headers={'referer': reference})
			file=re.compile('[^"|\']+\.mp4').findall(mp4)
			PlayUrl(name, file[0] + "|Referer="+ reference, iconimage, name)
		else:
			xbmcgui.Dialog().ok('Play XD', 'Erro, tente novamente em alguns minutos')
	except:
		xbmcgui.Dialog().ok('Play XD', 'Erro, tente novamente em alguns minutos')
...
def PlayTVCB(): #103
	#ST(url)
	link = common.OpenURL("https://canaisgratis.info/"+url)
	...
	PlayUrl(name, m[0] + "|Referer="+ reference + "&User-Agent=Mozilla/5.0 (Windows NT 10.0 Win64 x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/79.0.3945.45 Safari/537.36 Edg/79.0.309.30", iconimage, name, "")
